...
//
    public static final Breed MAXRUFOUS = new Breed(new Breed.Properties().setData("MaxRufous", 0.7F, 0.8F, Breed.Rarity.ORDINARY)
    ...
    public static final Breed MINRUFOUS = new Breed(new Breed.Properties().setData("MinRufous", 0.7F, 0.8F, Breed.Rarity.ORDINARY)
    ...
    public static final Breed PASSIVE = new Breed(new Breed.Properties().setData("Passive", 0.7F, 0.8F, Breed.Rarity.ORDINARY)
        .setGeneSketch(new GeneSketch().add(0, "1"), new GeneSketch().add(72, "1","1","1","1")));

    public static final Breed KOI = new Breed(new Breed.Properties().setData("Koi", 0.7F, 0.8F, Breed.Rarity.ORDINARY)
    ...
    public static final Breed MUSTARDGAS = new Breed(new Breed.Properties().setData("MustardGas", 0.7F, 0.8F, Breed.Rarity.ORDINARY)
        .setGeneSketch(new GeneSketch().add(0, "1"), new GeneSketch().add(0, "1,2").add(6, "1|2", "2").add(24, "2", "1|2", "_", "_", "2").add(42, "3")));

    public static final Breed BLUEMARBLE = new Breed(new Breed.Properties().setData("BlueMarble", 0.7F, 0.8F, Breed.Rarity.ORDINARY)
    ...
    public static final Breed SALAMANDER = new Breed(new Breed.Properties().setData("Salamander", 0.7F, 0.8F, Breed.Rarity.ORDINARY)
    ...
    public static final Breed NEMO = new Breed(new Breed.Properties().setData("Nemo", 0.7F, 0.8F, Breed.Rarity.ORDINARY)
