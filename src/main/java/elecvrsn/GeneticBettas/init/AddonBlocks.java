...
public class AddonBlocks {
    ...
    public static final RegistryObject<Block> SPADELEAF_SWORD = BLOCKS_DEFERRED_REGISTRY.register("spadeleaf_sword", () -> new SmallTankPlant(Block.Properties.of(Material.PLANT, MaterialColor.PLANT).sound(SoundType.BIG_DRIPLEAF).noCollission().instabreak().noOcclusion()));
    public static final RegistryObject<Block> TALL_SPADELEAF_SWORD = BLOCKS_DEFERRED_REGISTRY.register("tall_spadeleaf_sword", () -> new LargeTankPlant(Block.Properties.of(Material.PLANT, MaterialColor.PLANT).sound(SoundType.BIG_DRIPLEAF).noCollission().instabreak().noOcclusion()));
