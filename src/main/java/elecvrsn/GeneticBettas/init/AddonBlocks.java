...
//    public static final RegistryObject<Block> TANK_GLASS = BLOCKS_DEFERRED_REGISTRY.register("tank_glass", () -> new TankGlassBlock(Block.Properties.of(Material.GLASS, MaterialColor.WOOL).sound(SoundType.GLASS)));
    ...
    public static final RegistryObject<Block> SPADELEAF_SWORD = BLOCKS_DEFERRED_REGISTRY.register("spadeleaf_sword", () -> new SmallTankPlant(Block.Properties.of(Material.PLANT, MaterialColor.PLANT).sound(SoundType.BIG_DRIPLEAF).strength(0.3F).noOcclusion()));
