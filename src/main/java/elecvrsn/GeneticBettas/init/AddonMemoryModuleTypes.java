...
public class AddonMemoryModuleTypes {
    ...
    public static final RegistryObject<MemoryModuleType<List<UUID>>> TRUSTED_BETTAS = MEMORY_MODULE_TYPE_DEFERRED_REGISTRY.register("trusted_bettas", () -> new MemoryModuleType<List<UUID>>(Optional.empty()));
